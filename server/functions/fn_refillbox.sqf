...
switch (_boxType) do
{
	...
	Case "GroupEliteVenturePack":
	{
		...
		_boxItems = 
		[
			["wep", ["srifle_EBR_ARCO_pointer_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(10,10)],
			["wep", ["srifle_DMR_03_ARCO_F", "srifle_DMR_03_SOS_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(10,10],
			["wep", ["srifle_DMR_06_camo_khs_F", "srifle_DMR_06_olive_F", "srifle_DMR_06_camo_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(10,12)],
            ["wep", ["MMG_01_hex_ARCO_LP_F", "MMG_01_tan_F", "MMG_01_hex_F"], RANDOM_BETWEEN(1,1), RANDOM_BETWEEN(2,3)],
			["wep", ["MMG_02_camo_F", "MMG_02_black_F", "MMG_02_sand_F", "MMG_02_sand_RCO_LP_F", "MMG_02_black_RCO_BI_F"], RANDOM_BETWEEN(1,1), RANDOM_BETWEEN(2,3)],
			["wep", ["LMG_Mk200_MRCO_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(2,4)],
            ["wep", ["srifle_DMR_05_DMS_snds_F", "srifle_DMR_05_KHS_LP_F", "srifle_DMR_05_DMS_F", "srifle_DMR_05_SOS_F", "srifle_DMR_05_MRCO_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(6,8)],
			["wep", ["srifle_GM6_SOS_F", "srifle_GM6_F"], RANDOM_BETWEEN(1,1)],
			["mag", ["5Rnd_127x108_APDS_Mag"], RANDOM_BETWEEN(10,12)],
			...
			["itm",	["V_PlateCarrierIAGL_dgtl", "V_PlateCarrierIA2_dgtl", "V_PlateCarrierGL_rgr"], RANDOM_BETWEEN(3,4)],
			...
			["itm", ["optic_Nightstalker", "optic_tws"], RANDOM_BETWEEN(3,4)],
			["itm", ["muzzle_snds_H_MG"], RANDOM_BETWEEN(1,2)],
			["itm", ["muzzle_snds_B"], RANDOM_BETWEEN(1,3)],
			["itm", ["bipod_01_F_snd", "bipod_01_F_blk", "bipod_01_F_mtp"], RANDOM_BETWEEN(2,2)],
			["itm", ["bipod_02_F_blk", "bipod_02_F_tan", "bipod_02_F_hex"], RANDOM_BETWEEN(2,2)],
			["itm", ["bipod_03_F_blk", "bipod_03_F_oli"], RANDOM_BETWEEN(2,2)],
	...
	Case "GroupEliteVenturePackLite":
	{
		_boxItems:
		[
			["wep", ["srifle_EBR_ARCO_pointer_F"], RANDOM_BETWEEN(1,1), RANDOM_BETWEEN(5,10)],
			["wep", ["srifle_DMR_06_camo_khs_F", "srifle_DMR_06_olive_F", "srifle_DMR_06_camo_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(10,12)],
			["wep", ["LMG_Mk200_MRCO_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(2,4)],
			["wep", ["srifle_DMR_01_SOS_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(5,10)],
			...
			["itm",	["V_PlateCarrierIAGL_dgtl", "V_PlateCarrierIA2_dgtl", "V_PlateCarrierGL_rgr"], RANDOM_BETWEEN(3,4)],
			["itm", ["optic_LRPS", "optic_SOS"], RANDOM_BETWEEN(2,3)],
			["itm", ["optic_Nightstalker", "optic_tws"], RANDOM_BETWEEN(3,4)],["itm", ["optic_LRPS", "optic_SOS"], RANDOM_BETWEEN(2,3)],
			["itm", ["H_HelmetB_light_sand", "H_HelmetB_light_desert", "H_HelmetB_light_grass"], RANDOM_BETWEEN(3,5)]

...
_setupObjects =
{
	...
	[_box1, "GroupEliteVenturePackLite"] call fn_refillbox;
	...
	_missionHintText = "An armed expedition is trying to recover a Group Elite Crate.<br/>If you want to capture them, you will need diving gear and an underwater weapon.";
};
